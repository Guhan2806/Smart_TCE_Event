...
function Event1() {
  return (
    <div>
      <a
        href="/dashboard"
        className="flex flex-col mb-5 items-center bg-pink-700 rounded-lg border shadow-md md:flex-row md:max-w-xl hover:bg-pink-600 hover:scale-105"
      >
        <img
        ...
        <div className="flex flex-col justify-between p-4 leading-normal">
          <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
            Smart TCE Hackathon IE 
          </h5>
          <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
            Innovate Texh Solution for existing problem statements for TCE{" "}
          </p>
        </div>
